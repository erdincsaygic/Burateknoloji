...
namespace StilPay.UI.Admin.Controllers
{
    ...
    public class MemberTransactionController : BaseController<MemberTransaction>
    {
        private readonly IMemberTransactionManager _manager;

        public MemberTransactionController(IMemberTransactionManager manager, IHttpContextAccessor httpContext) : base(httpContext)
        {
            _manager = manager;
        }
