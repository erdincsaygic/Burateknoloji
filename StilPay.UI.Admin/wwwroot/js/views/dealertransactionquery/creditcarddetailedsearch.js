    ...
    $('#TableCard').DataTable({
        ...
        "ajax": {
            ...
            "data": function (d) {
                ...
                d.CardNumber = $("#txtCardNumber").val();
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                    $(nTd).attr('class', 'text-center');
                    if ((oData.rebateID == "" || oData.rebateID == null) && oData.entityID) {
                        if (!oData.isForeign) {
                            $(nTd).html(sData = '<button class="btn btn-custom btn-sm" onclick="window.open(\'/DealerCreditCardTransaction/Edit/' + oData.entityID + '\', \'_blank\')" >İşlem Detayı</button>');
                        }
                        else {
                            $(nTd).html(sData = '<button class="btn btn-custom btn-sm" onclick="window.open(\'/DealerForeignCreditCardTransaction/Edit/' + oData.entityID + '\', \'_blank\')" >İşlem Detayı</button>');
                        }
                    } else {
                        $(nTd).html(sData = '<button class="btn btn-warning btn-sm" onclick="window.open(\'/DealerRebateTransaction/Edit/' + oData.rebateID + '\', \'_blank\')" >İade Detayı</button>');
                    }
