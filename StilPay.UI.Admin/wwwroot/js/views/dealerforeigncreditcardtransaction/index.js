$(document).ready(function () {
    ...
    $("#btnExcel").click(function () {
        downloadExcel("Üye-İşyeri-Yurt-Dışı-Kredi-Kartı-Ödeme-Hareketleri", mainData);
    });
...
function getData() {
    $('#Table').DataTable({
        ...
        "ajax": {
            "url": "/DealerForeignCreditCardTransaction/GetData",
            "type": "POST",
            "data": function (d) {
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                    $(nTd).attr('class', 'text-center');
                    $(nTd).html(sData = '<a href="/DealerForeignCreditCardTransaction/Edit/' + sData + '" target="_blank" >Detay</a>');
                }
            }
        ],
