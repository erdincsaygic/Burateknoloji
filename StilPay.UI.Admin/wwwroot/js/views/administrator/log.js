            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                        ...
                        if (sData === true)
                            $(nTd).html(sData = '<span class="badge bg-success px-4 py-2">ONLINE</span>');
                        else
                            $(nTd).html(sData = '<span class="badge bg-danger px-4 py-2">OFFLINE</span>');
                    }
                },
                {
                    "aTargets": [1],
            ...
            success: function (list) {
                ...
                if (list)
                    $.each(list, function (i, item) {
                        grid.push([item.state, item.loginDate, item.exitDate, item.ipAddress, item.name, item.phone, item.email]);
                    });
