var urlEDIT = '/Announcement/Edit/__id__';
var urlDELETE = '/Announcement/Drop';
...
var Table = function () {
    ...
    var initData = function () {
        ...
        $.get('/announcement/gets', function (list) {
            var otbl = $('#Table').DataTable();
            if (list)
                $.each(list, function (i, item) {
                    otbl.rows.add([[item.statusFlag, item.startDate, item.endDate, item.title, item.body, item.id, item.id]]);
                })
            otbl.draw();
        }).fail(function () {
            onFailure();
