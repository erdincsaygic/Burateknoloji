var urlEDIT = '/dealer/edit/__id__';
var urlDELETE = '/dealer/drop';
    ...
    $('#Table').DataTable({
        ...
        "columnDefs": [
            ...
            },
            {
                ...
                "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                    $(nTd).attr('class', 'text-center');
                    $(nTd).html(sData = '<a href="/Dealer/Edit/' + sData + '" target="_blank" >Detay</a>');
                }
            }
        ],
        ...
        var otable = table.dataTable({
            ...
            "columnDefs": [
                ...
                },
                {
                    ...
                    "fnCreatedCell": function (nTd, sData, oData, iRow, iCol) {
                        $(nTd).attr('class', 'text-center');
                        $(nTd).html(sData = '<a href="/Dealer/Edit/' + sData + '" >Detay</a>');
                    }
                },
                {
                    "aTargets": [9],
