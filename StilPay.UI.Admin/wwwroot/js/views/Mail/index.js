var urlEDIT = '/Mail/Edit/__id__';
var urlDELETE = '/Mail/Drop';
...
var Table = function () {
    ...
    var initTable = function () {
        ...
        var otable = table.dataTable({
            ...
            "fnCreatedRow": function (nRow, aData, iDataIndex) {
                nRow.setAttribute("id", "tr_" + aData[4]);
            },
    ...
    var initData = function () {
        ...
        $.get('/Mail/gets', function (list) {
            var otbl = $('#Table').DataTable();
            if (list)
                $.each(list, function (i, item) {
                    otbl.rows.add([[item.statusFlag, item.category, item.name, item.body, item.id, item.id]]);
                })
            otbl.draw();
        }).fail(function () {
            onFailure();
