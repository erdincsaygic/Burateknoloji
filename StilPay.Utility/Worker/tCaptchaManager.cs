...
{
    public static class tCaptchaManager
    {
        ...
        public static CaptchaResult GenerateCaptchaImage(int width, int height)
        {
            ...
            using (Bitmap baseMap = new Bitmap(width, height))
            {
                using (Graphics graph = Graphics.FromImage(baseMap))
                {
                    ...
                    {
                        int redlow = 15, greenLow = 22, blueLow = 125;
                    ...
                    void DrawDisorderLine()
                    {
                        ...
                        for (int i = 0; i < 3; i++)
                        {
                            ...
                            Point startPoint = new Point(rand.Next(0, width / 4), rand.Next(0, height));
                            Point endPoint = new Point(rand.Next(width * 3 / 4, width), rand.Next(0, height));
