...
namespace StilPay.Utility.LidioPos.Models.LidioPosFinishPayment
{
    public class LidioPosFinishPaymentRequestResponseModel
    {
    ...
    public class InstrumentDetail
    {
        ...
        public object? directWiretransfer { get; set; }
        public object? instantLoan { get; set; }
        public object? marketPlaceBalance { get; set; }
        public EmoneyInfoNew emoney { get; set; }
        public IdealInfo ideal { get; set; }
    ...
    public class AcquirerResultDetail
    {
        ...
        public EmoneyAccountInfo emoneyAccount { get; set; }
        public SepaInfo sepa { get; set; }
    }
