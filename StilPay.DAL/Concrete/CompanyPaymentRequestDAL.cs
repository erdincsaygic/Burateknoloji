...
{
    public class CompanyPaymentRequestDAL : BaseDAL<CompanyPaymentRequest>, ICompanyPaymentRequestDAL
    {
        public override string TableName
        {
            get { return "CompanyPaymentRequests"; }
        }

        public string SetStatus(CompanyPaymentRequest entity)
        {
            try
            {
