...
{
    public class MemberPaymentRequestDAL : BaseDAL<MemberPaymentRequest>, IMemberPaymentRequestDAL
    {
        public override string TableName
        {
            get { return "MemberPaymentRequests"; }
        }

        public string SetStatus(MemberPaymentRequest entity)
        {
            try
            {
