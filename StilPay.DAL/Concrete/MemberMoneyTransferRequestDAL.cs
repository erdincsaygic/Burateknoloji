...
{
    public class MemberMoneyTransferRequestDAL : BaseDAL<MemberMoneyTransferRequest>, IMemberMoneyTransferRequestDAL
    {
        public override string TableName
        {
            get { return "MemberMoneyTransferRequests"; }
        }

        public string SetStatus(MemberMoneyTransferRequest entity)
        {
            try
            {
