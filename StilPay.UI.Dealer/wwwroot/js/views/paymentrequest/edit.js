...
$(document).ready(function () {
    ...
    if (banks && banks.length > 0) {
        ...
        $("#txtBank").val(banks[0].Bank);
        $("#entity_IDBank").val(banks[0].IDBank);
    ...
    $(".bank").click(function () {
        ...
        for (i = 0; i <= banks.length; i++) {
            if (banks[i].IDBank === idBank) {
                $("#imgBank").attr("src", '../img/banks/' + banks[i].Img);
                $("#txtBank").val(banks[i].Bank);
