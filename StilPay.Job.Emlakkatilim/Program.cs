...
namespace StilPay.Job.Emlakkatilim
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(
                    string.Concat("-------------------------------------------------",
                                  ...
                                  "            STILPAY EMLAKKATILIM-BANK WORKING..            ",
                                   Environment.NewLine, Environment.NewLine,
                                  "-------------------------------------------------")
            );
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    // Hareketler
                    var movements = parsed.Details; // List<EkbTransactionDetail>
                             ...
                             .OrderByDescending(o => o.SystemDate))
                    {
                        ...
                        string normalizedDescription = hareket.Description != null
                                                       ? hareket.Description.Replace(" ", "").ToLower(trCulture)
                                                       : "";
        ...
        private static string DigitsOrNull(string s, int min = 4, int max = 30)
        {
