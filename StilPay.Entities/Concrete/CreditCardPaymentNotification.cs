...
{
    public class CreditCardPaymentNotification : BaseEntity
    {
        ...
        [FieldAttribute(AutoIncrement = false, PK = false, FK = false, Name = "ParamCommission", FieldType = Enums.FieldType.Decimal, Description = "", Nullable = false)]
        public decimal ParamCommission { get; set; }

        [FieldAttribute(AutoIncrement = false, PK = false, FK = false, Name = "PayNKolayCommission", FieldType = Enums.FieldType.Decimal, Description = "", Nullable = false)]
        public decimal PayNKolayCommission { get; set; }
        ...
        [FieldAttribute(AutoIncrement = false, PK = false, FK = false, Name = "IsCaughtInBlocked", FieldType = Enums.FieldType.Bit, Description = "", Nullable = true)]
        public bool IsCaughtInBlocked { get; set; }

        //[FieldAttribute(AutoIncrement = false, PK = false, FK = false, Name = "SmsVerificationDescription", FieldType = Enums.FieldType.NVarChar, Description = "", Nullable = true)]
        //public string SmsVerificationDescription { get; set; }

        //[FieldAttribute(AutoIncrement = false, PK = false, FK = false, Name = "IsSmsVerifactionFaulty", FieldType = Enums.FieldType.Bit, Description = "", Nullable = true)]
        //public bool IsSmsVerifactionFaulty { get; set; }
